...
.. code-block::
  ...
  $ conda activate ECGHeartbeatCategorization
...
.. code-block::
  ...
  $ pytest tests
  $ ECGHeartbeatCategorization train -c experiments/config.yml
...
.. code-block::
  ...
  ECGHeartbeatCategorization train -c experiments/config.yml -r path/to/checkpoint
